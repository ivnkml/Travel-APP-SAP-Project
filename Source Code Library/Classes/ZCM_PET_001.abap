CLASS zcm_pet_001 DEFINITION
  ...
  PUBLIC SECTION.
    ...
    " Fehlerkonstanten für verschiedene Validierungsfälle (jeweils mit T100-Textnummer und Attributen)
    CONSTANTS:
      BEGIN OF date_interval,
        msgid TYPE symsgid VALUE 'ZPET_MSG_001',
...
CLASS zcm_pet_001 IMPLEMENTATION.

  METHOD constructor ##ADT_SUPPRESS_GENERATION.

    " Setzt die Fehlermeldungs-Attribute für die Message-Klasse (Severity, Parameter etc.)
    super->constructor(
      previous = previous
    ).
    CLEAR me->textid.
